var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'http://localhost/smallholders/wp-content/plugins/beaver-builder-lite-version/',
		wpAjaxUrl : 'http://localhost/smallholders/wp-admin/admin-ajax.php'
	}
};(function($){
...
})(jQuery);var wpAjaxUrl = 'http://localhost/smallholders/wp-admin/admin-ajax.php';var flBuilderUrl = 'http://localhost/smallholders/wp-content/plugins/beaver-builder-lite-version/';